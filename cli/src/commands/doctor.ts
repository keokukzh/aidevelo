...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" aidevelo doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `aideveloai configure --section database` or `aideveloai onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadAideveloEnvFile(input.configPath);
