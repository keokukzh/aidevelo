...
import { agentApiKeys, companyMemberships, instanceUserRoles } from "@aideveloai/db";
...
interface IncomingMessageWithContext extends IncomingMessage {
  aideveloUpgradeContext?: UpgradeContext;
}
...
export function setupLiveEventsWebSocketServer(
  ...
  wss.on("connection", (socket: WsSocket, req: IncomingMessage) => {
    const context = (req as IncomingMessageWithContext).aideveloUpgradeContext;
    if (!context) {
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    void authorizeUpgrade(db, req, companyId, url, {
      ...
      authAllowLocalImplicitBoard: opts.authAllowLocalImplicitBoard,
      ...
      .then((context) => {
        ...
        reqWithContext.aideveloUpgradeContext = context;
