...
import { models as codexFallbackModels } from "@aideveloai/adapter-codex-local";
import { models as cursorFallbackModels } from "@aideveloai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@aideveloai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.AIDEVELO_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.AIDEVELO_OPENCODE_COMMAND = "__aidevelo_missing_opencode_command__";
