...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@aideveloai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: AideveloPluginManifestV1, pluginDbId?: string): void;
