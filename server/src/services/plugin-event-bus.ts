/**
 * PluginEventBus — typed in-process event bus for the Aidevelo plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@aideveloai/shared";
import type { PluginEvent, EventFilter } from "@aideveloai/plugin-sdk";
