 ...
 */
import type { CompanyPortabilityManifest } from "@aideveloai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Aidevelo](https://aidevelo.ing)");
  lines.push("");
