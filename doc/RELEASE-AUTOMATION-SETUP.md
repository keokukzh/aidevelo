...
This document covers the GitHub and npm setup required for the current Aidevelo release model:
...
Do this for every public package that Aidevelo publishes.
...
3. add a trusted publisher for the GitHub repository `aideveloai/aidevelo`
...
2. revoke any personal automation token that used to publish Aidevelo
