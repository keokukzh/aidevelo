...
This is intentionally separate from the normal Aidevelo dev image.
...
```sh
review-checkout-pr aideveloai/aidevelo 432
cd /work/checkouts/aideveloai-aidevelo/pr-432
```
...
## Preview the Aidevelo app from the PR
...
- Aidevelo's embedded PostgreSQL and local storage stay inside the container home volume via `AIDEVELO_HOME=/home/reviewer/.aidevelo-review`.
