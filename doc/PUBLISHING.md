...
Low-level reference for how Aidevelo packages are prepared and published to npm.
...
Aidevelo no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `aideveloai`, imports code from workspace packages such as:
...
Aidevelo uses calendar versions:
...
- `aideveloai@2026.318.1-canary.2`
