...
- installed adapter list for this Aidevelo instance
...
## 8. New Skill: `aidevelo-create-agent`

Create new skill directory:

- `skills/aidevelo-create-agent/SKILL.md`
...
Also update `skills/aidevelo/SKILL.md` to reference this skill for hiring workflows.
...
- `aidevelo-create-agent` skill + docs updates
