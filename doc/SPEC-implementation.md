...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.aidevelo/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.aidevelo/instances/default/data/storage` (`local_disk`)
...
- `.aidevelo.yaml` sidecar for Aidevelo-specific fidelity
...
- export emits a clean vendor-neutral markdown package plus `.aidevelo.yaml`
