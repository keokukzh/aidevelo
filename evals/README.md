...
Eval framework for testing Aidevelo agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Aidevelo heartbeat skill:
