# Aidevelo API Reference

Detailed reference for the Aidevelo control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Aidevelo Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "aidevelo-mobile",
    "cwd": "/Users/me/aidevelo-mobile",
    "repoUrl": "https://github.com/acme/aidevelo-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `aidevelo-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
