...
- Running a Python script that calls the Aidevelo API
...
1. Aidevelo spawns the configured command as a child process
2. Standard Aidevelo environment variables are injected (`AIDEVELO_AGENT_ID`, `AIDEVELO_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Aidevelo API and perform work.
