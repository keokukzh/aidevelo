...
Manage companies within your Aidevelo instance.
...
Company logo uploads use the normal Aidevelo attachment size limit.
...
| `logoUrl` | string | Optional Aidevelo asset content path for the stored logo image |
