...
summary: Set up Aidevelo for local development
---

Run Aidevelo locally with zero external dependencies.
...
No Docker or external database required. Aidevelo uses embedded PostgreSQL automatically.
