...
Aidevelo supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Aidevelo?** Use `local_trusted` (the default)
