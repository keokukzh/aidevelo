...
- `AIDEVELO_APPROVAL_ID` — the resolved approval
- `AIDEVELO_APPROVAL_STATUS` — `approved` or `rejected`
- `AIDEVELO_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
