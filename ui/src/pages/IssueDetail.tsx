...
import type { ActivityEvent } from "@aideveloai/shared";
import type { Agent, IssueAttachment } from "@aideveloai/shared";
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`aidevelo:issue-comment-draft:${issue.id}`}
            enableReassign
