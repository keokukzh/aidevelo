...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@aideveloai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@aideveloai/adapter-utils").TranscriptEntry[];
