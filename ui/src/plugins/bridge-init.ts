 ...
 *
 * This is placed on `globalThis.__aideveloPluginBridge__` and consumed by
...
declare global {
  ...
  var __aideveloPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__aideveloPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__aideveloPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
