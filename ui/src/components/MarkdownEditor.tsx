...
import { buildProjectMentionHref, parseProjectMentionHref } from "@aideveloai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("aidevelo-project-mention-chip");
      ...
      link.classList.add("aidevelo-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative aidevelo-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("aidevelo-mdxeditor", !bordered && "aidevelo-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "aidevelo-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
