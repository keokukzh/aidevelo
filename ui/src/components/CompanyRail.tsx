...
import type { Company } from "@aideveloai/shared";
import { CompanyPatternIcon } from "./CompanyPatternIcon";

const ORDER_STORAGE_KEY = "aidevelo.companyOrder";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Aidevelo icon - aligned with top sections (implied line, no visible border) */}
      <div className="flex items-center justify-center h-12 w-full shrink-0">
        <img
          src="/AID-thumbnail-white.png"
          alt="AID"
          className="h-[41px] w-[46px] object-contain select-none pointer-events-none"
        />
      </div>
