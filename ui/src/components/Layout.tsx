...
const INSTANCE_SETTINGS_MEMORY_KEY = "aidevelo.lastInstanceSettingsPath";
...
export function Layout() {
  ...
  const handleDashboardLogoClick = useCallback(() => {
    const dashboardCompany = matchedCompany ?? selectedCompany;
    if (isMobile) setSidebarOpen(false);
    navigate(dashboardCompany ? `/${dashboardCompany.issuePrefix}/dashboard` : "/dashboard");
  }, [isMobile, matchedCompany, navigate, selectedCompany, setSidebarOpen]);
