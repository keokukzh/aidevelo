...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within AideveloPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Aidevelo host.
 *
...
export interface AideveloPluginManifestV1 {
   ...
   */
  minimumAideveloVersion?: PluginMinimumHostVersion;
