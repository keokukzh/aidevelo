...
export const COMPANY_RUNTIME_MODES = ["legacy_configurable", "managed"] as const;
export type CompanyRuntimeMode = (typeof COMPANY_RUNTIME_MODES)[number];
...
export const INTERNAL_AGENT_ADAPTER_TYPES = [
  ...AGENT_ADAPTER_TYPES,
  "managed_service",
] as const;
export type AgentAdapterType = (typeof INTERNAL_AGENT_ADAPTER_TYPES)[number];

export const CLAUDE_LOGIN_COMPATIBLE_ADAPTER_TYPES = [
  "claude_local",
  "managed_service",
 ...
 * Aidevelo UI where plugin components can be rendered.
 *
