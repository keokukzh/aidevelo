...
function requireCapability(manifest: AideveloPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Aidevelo server runtime.
 */
