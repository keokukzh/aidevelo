/**
 * Bundling presets for Aidevelo plugins.
 *
 ...
 * to match the Aidevelo plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@aideveloai/plugin-sdk/ui",
    "@aideveloai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@aideveloai/plugin-sdk"],
  };
