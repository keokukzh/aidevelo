 ...
 * channel.
 *
 * The Aidevelo plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@aideveloai/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Aidevelo messages.
 */
...
/**
 * Aidevelo plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Aidevelo instance. */
    instanceId: string;
    /** Semver version of the running Aidevelo host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
