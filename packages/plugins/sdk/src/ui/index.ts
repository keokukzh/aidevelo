/**
 * `@aideveloai/plugin-sdk/ui` — Aidevelo plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@aideveloai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@aideveloai/plugin-sdk/ui";
 *
