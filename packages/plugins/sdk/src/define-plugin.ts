/**
 * `definePlugin` — the top-level helper for authoring a Aidevelo plugin.
 *
...
// ---------------------------------------------------------------------------
// AideveloPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface AideveloPlugin {
 ...
 * @returns A sealed `AideveloPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@aideveloai/plugin-sdk";
