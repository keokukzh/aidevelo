import type { PluginLauncherRegistration } from "@aideveloai/plugin-sdk";

export const PLUGIN_ID = "aidevelo-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".aidevelo-kitchen-sink-demo.txt",
} as const;
