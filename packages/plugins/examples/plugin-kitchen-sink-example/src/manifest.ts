...
const manifest: AideveloPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Aidevelo plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Aidevelo",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Aidevelo domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
