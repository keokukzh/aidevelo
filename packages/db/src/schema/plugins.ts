...
import type { PluginCategory, PluginStatus, AideveloPluginManifestV1 } from "@aideveloai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<AideveloPluginManifestV1>().notNull(),
