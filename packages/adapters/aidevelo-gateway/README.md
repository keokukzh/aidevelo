...
This document describes how `@aideveloai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Aidevelo logs/transcript parsing
